          ...
          <MDBCol md='4'>
            <MDBCardBody className='d-flex flex-column'>
              ...
              <h5 className="fw-normal my-4 pb-3" style={{letterSpacing: '1px'}}>Sign into your account</h5>
                ...
                <MDBInput wrapperClass='mb-4' placeholder='Enter your email' id='formControlLg' type='email' name='email' value={inputText.email} onChange={handleOnChange} size="lg"/>
                <MDBInput wrapperClass='mb-4' placeholder='Enter your password' id='formControlLg' type='password' name='password' value={inputText.password} onChange={handleOnChange} size="lg"/>

              <Button className="mb-4 px-5 " color='dark' onClick={handleSubmit} size='lg'>Login</Button>
              <a className="small text-muted" href="#!">Forgot password?</a>
              <p className="mb-5 pb-lg-2" style={{color: '#393f81'}}>Don't have an account? <a href="#!" style={{color: '#393f81'}}><span><Link to="/register">Register here</Link></span></a></p>
